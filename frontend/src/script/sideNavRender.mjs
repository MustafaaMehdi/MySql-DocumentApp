...
export default function sideNavRender() {
	...
	let logoText = createElement('h2', `logoText`, 'logoText', `UniDoc`);
	...
	let profileImg = createElement('img', `profileImg`, 'profileImg', ``);
	...
	myDocumentsBtn.setAttribute('aria-label', 'My documents');
	...
	createDocumentBtn.setAttribute('aria-label', 'Create new document');
